...
class AppointmentController extends Controller
{
    ...
    public function approval(Request $request,$id){
        ...
        // send email
        Mail::to($appointment->email)->send(new AppointmentConfirmation($appointment->name,$request->appointment));
        // send message mob
        // $receiverNumber = $appointment->phone;
        // $message = "عزيزي المريض" . " " . $appointment->name . " " . "تم حجز موعدك بتاريخ " . $request->appointment;
