...
class GroupInvoices extends Component
{
    ...
    public $tax_rate = 0 , $tax_value = 0,$Total_after_discount = 0;
    ...
    public function get_price()
    {
        ...
        $this->Total_after_discount = Group::where('id', $this->Group_id)->first()->Total_after_discount;
